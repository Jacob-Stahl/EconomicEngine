...
- ?? In the real world, all people have the same basic biological requirements that are more easily modeled. Agents might have different preferences for wants/needs higher up on the pyramid. This might be modeled with differently shaped hunger curves that vary between agents.
